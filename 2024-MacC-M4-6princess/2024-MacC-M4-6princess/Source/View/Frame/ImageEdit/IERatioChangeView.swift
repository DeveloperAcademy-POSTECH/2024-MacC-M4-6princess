...
struct IERatioChangeView: View {
    ...
    @State private var currentAspectRatio: CropRatio = .horizantal // 초기값을 4:3으로 지정
                        ...
                        if let image = rawImage {
                            switch currentAspectRatio {
                                ...
                                case .vertical:
                                    ...
                                    currentAspectRatio = .horizantal
                            }
                        }
                    }) {
                        Image(systemName: currentAspectRatio == .horizantal ? "rotate.right" : "rotate.left") // 비율에 따른 아이콘 교차 변경
    ...
    private func cropImage(image: UIImage, aspectRatio: CropRatio) -> UIImage? {
        ...
        let aspectSize = aspectRatio.size
